...
<nav>
    <div class="top-nav">
        <a class="homepage-link-nav" href="../index.php">
            <img alt="ff.cars logotype" src="/assets/icons/ff_cars_logo.svg" />
        </a>
        ...
        <div class="tickets">
            <?php if ($ticket): ?>
                <div class="ticket-container">
                    ...
                    <p><?= fetchBrand(htmlspecialchars($ticket['license_plate']));?> <?= fetchModel(htmlspecialchars($ticket['license_plate'])); ?> <?= fetchSegment(htmlspecialchars($ticket['license_plate'])); ?>
                    <p><strong>License Plate:</strong> <?= htmlspecialchars($ticket['license_plate']); ?></p>
                    <p><strong>User ID:</strong> <?= htmlspecialchars($ticket['id']); ?></p>
                    <p><strong>Begin Time:</strong> <?= htmlspecialchars($ticket['begin_time']); ?></p>
                    <p><strong>End Time:</strong> <?= htmlspecialchars($ticket['end_time']); ?></p>
